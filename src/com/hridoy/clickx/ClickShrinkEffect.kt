...
class ClickShrinkEffect(view: View, parentView: View) {

    private val weakRefView = WeakReference(parentView)
...
fun applyClickShrink(view: View, parentView: View): View {
    return parentView.apply {
        ClickShrinkEffect(view, parentView)
    }
}
